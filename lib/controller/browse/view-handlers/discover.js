...
class DiscoverViewHandler extends BaseViewHandler {
    ...
    _getParamsList(params, discoverOptions) {
        ...
        let title = UIHelper.constructListTitleWithLink(UIHelper.addBandcampIconToListTitle(bandcamp.getI18n(view.inSection ? 'BANDCAMP_DISCOVER_SHORT' : 'BANDCAMP_DISCOVER')), setDefaultLink, true);
