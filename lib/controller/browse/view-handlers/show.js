        ...
        showModel.getShow(showUrl).then( (show) => {
            ...
            if (view.view === 'albums') {
                ...
                let switchViewLink = {
                    ...
                    onclick: 'angular.element(\'#browse-page\').scope().browse.fetchLibrary({uri: \'' + self._constructUriWithParams({ view: 'tracks', noExplode: 1 }) + '\'}, false)',
                    icon: {
                        type: 'fa',
                ...
                let featuredAlbumsSection = {
                    title: UIHelper.constructListTitleWithLink(bandcamp.getI18n('BANDCAMP_RELATED_ALBUMS'), switchViewLink, false),
                    availableListViews: ['list', 'grid'],
                    items: []
                };
                ...
                let switchViewLink = {
                    url: '#',
                    text: bandcamp.getI18n('BANDCAMP_SHOW_RELATED_ALBUMS'),
                    onclick: 'angular.element(\'#browse-page\').scope().browse.fetchLibrary({uri: \'' + self._constructUriWithParams({ view: 'albums', noExplode: 1 }) + '\'}, false)',
                    icon: {
                        type: 'fa',
                        class: 'fa fa-arrow-circle-right',
                        float: 'right',
