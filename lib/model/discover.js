...
class DiscoverModel extends BaseModel {
    ...
    getDiscoverOptions() {
        return bandcamp.getCache().cacheOrPromise(this.getCacheKeyForFetch('discoverOptions'), () => {
            return bcfetch.getDiscoverOptions();
        });
    }
    ...
    getFetchPromise(options) {
        ...
        return bandcamp.getCache().cacheOrPromise(this.getCacheKeyForFetch('discover', queryParams), () => {
            return bcfetch.discover(queryParams);
        });
    }
